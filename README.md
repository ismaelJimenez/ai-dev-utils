...
|--------|-------------|---------|----------|
| [**wingman**](https://github.com/ismaelJimenez/wingman) | Structured workflows for developing new features with brainstorming, ideation, and decision-making | 0.3.1 | Productivity |
